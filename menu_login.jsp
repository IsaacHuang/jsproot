...
<body>
		<%
			out.print(session.getAttribute("name")+"您好!歡迎蒞臨本網站!");
		%>
<form name="form1" method="post" action="add_log.jsp">
<font color="926387"><h3>留言板：<h3></font>
<%out.print("姓名:"+session.getAttribute("name")+"<br>");%>
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           ...
           for(int i=1;i<=page_num;i++) //使用get傳輸方式,建立1,2,...頁超連結
              {
			   out.print("<a href='menu_login.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
           }
           out.println("<p>");
