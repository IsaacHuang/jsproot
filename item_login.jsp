           ...
           while(rs.next())
                {
				  ...
				  while(a!=1)
				  {
				  out.println("<tr><td></td><td>商品名稱</td><td>商品介紹</td><td>商品價格</td><td>數量</td><td></td></tr>");
				  a=1;
				  }
				  ...
				  out.println("<input type='number' required=required' name='quantity' min='1' max="+rs.getString("quantity")+"><input type='submit' name='Submit' value='放入購物車'></form></td></tr>");
