...
<form name="form1" method="post" action="../member/check.jsp">
 ...
 <%-- 右邊區塊 START --%>
	  ...
	  <font face="Arial Unicode MS" size="6"><font color="#FFFFFF">關於</font><br><br>
	  <img border="0" src="../material/fb.png" width="100" height="100"><br>
	  <a href="http://www.facebook.com/profile.php?id=1582018302"><img border="0" src="../material/about01.png" width="160" height="32"></a><br>
	  <a href="http://www.facebook.com/profile.php?id=100001220936791"><img border="0" src="../material/about02.png" width="160" height="32"></a><br>
